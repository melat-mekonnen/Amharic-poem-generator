...
function generatePoem(event) {
    ...
    let context = "you are good love poem writer and you love to connet it with nature and you mission is to generate 4 line poem using html . make sure to follow user instructions i want to stop the writting after it do once.I want only the poem with no other explanation and it should have poem title with stanza now add this at the end <strong> SheCodes AI</strong>.";
